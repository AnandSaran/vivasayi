...
class _IrrigationScreenState extends State<IrrigationScreen> {
  ...
  Widget _buildShopFilterView() {
    return BlocBuilder<IrrigationShopAddressBloc, ShopAddressState>(
  ...
  void loadShop(Location location) {
    context.read<IrrigationShopBloc>().add(LoadShop(location));
    context.read<IrrigationShopAddressBloc>().add(LoadShopAddress(location));
  }
