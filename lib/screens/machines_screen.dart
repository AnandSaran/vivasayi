...
class _MachinesScreenState extends State<MachinesScreen> {
  ...
  Widget _buildShopFilterView() {
    return BlocBuilder<MachineShopAddressBloc, ShopAddressState>(
  ...
  _buildShopListView() {
    return BlocBuilder<MachineShopBloc, ShopState>(builder: (context, state) {
  ...
  void loadShop(Location location) {
    context.read<MachineShopBloc>().add(LoadShop(location));
    context.read<MachineShopAddressBloc>().add(LoadShopAddress(location));
  }
