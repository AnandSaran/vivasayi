...
class AgriProductShopAddressBloc
    extends Bloc<ShopAddressEvent, ShopAddressState> {
  final LocationRepository _locationRepository;

  AgriProductShopAddressBloc({required LocationRepository locationRepository})
